"""Shared figure size and typography for publication-ready composite panels.

Panel width PLOT_W_MM (52.5 mm) is sized for ~3 panels across a full-width
full-width figure (174 mm). Assemble multi-panel figures at 174 mm width in
...
MM_PER_IN = 25.4
# Sub-panel width for ~3-across layout in a 174 mm full-width journal figure
...
def apply_cell_press_style():
    """Apply Arial-first typography and embeddable fonts for publication export."""
